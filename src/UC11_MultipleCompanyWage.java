...
public class UC11_MultipleCompanyWage implements EmpWage {
    static String company;
    static int working_days;
    static int wage_per_hr;
    static int working_hours_per_month;

    public UC11_MultipleCompanyWage() {
...
//                    working_hours_per_month++;
    ...
    public static void main(String[] args) {
        UC11_MultipleCompanyWage companyWage=new UC11_MultipleCompanyWage();
        companyWage.computeEmpWage();
        companyWage.printDetails();
    }
}